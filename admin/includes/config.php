...
*/
define('VIRTUAL_PATH', 'http://phagens.com/web210/'); 

define('PHYSICAL_PATH', '/home/phagens/phagens.com/web210/'); # Physical (PHP) 'root' of application for file & upload reference
