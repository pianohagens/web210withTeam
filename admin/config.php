...
*/
define('VIRTUAL_PATH', 'http://phagens.com/web210/admin/'); 

define('PHYSICAL_PATH', '/home/phagens/phagens.com/web210/admin/'); # Physical (PHP) 'root' of application for file & upload reference
...
define('/home/phagens/phagens.com/web210/admin/', PHYSICAL_PATH . 'includes/'); # Path to PHP include files - INSIDE APPLICATION ROOT

define('http://phagens.com/web210/admin/', VIRTUAL_PATH); # Could change to sub folder
